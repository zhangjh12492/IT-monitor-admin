...
//            jqTds[3].innerHTML = '<input type="text" class="form-control input-small" value="' + aData[3] + '">';
        ...
        function saveRow(oTable, nRow) {
            ...
            var sysCode=jqInputs[1].value;
            var sysDesc=jqInputs[2].value;
            if(id!=null&&id!=''){	//修改
            	$.ajax({
    	        	url:'/webSocketPro/updateSysInfo',
    	   			 type:'post',   
    	   			 ...
    	   			 success:function(data){
    	   				 if(data!=null && data!='' && data=='true'){
    	   		            oTable.fnUpdate(sysCode, nRow, 1, false);
    	   		            oTable.fnUpdate(sysDesc, nRow, 2, false);
//    	   		            oTable.fnUpdate(jqInputs[3].value, nRow, 3, false);
            	...
            	$.ajax({
    	        	url:'/webSocketPro/addSysInfo',
    	   			 type:'post',   
    	   			 data:{sysCode:sysCode,sysDesc:sysDesc},
    	   			 cache:false,
    	   			 async:false,
    	   			 timeout:1000*60,   
    	   			 success:function(data){
...
//            oTable.fnUpdate(jqInputs[3].value, nRow, 3, false);
        ...
        function deleteRow(oTable,nRow){
            ...
            var id=jqTd.html();
             $.ajax({
 	        	url:'/webSocketPro/deleteSysInfo',
 	   			 type:'post',   
 	   			 data:{id:id},
 	   			 cache:false,
 	   			 async:false,
...
//            "sAjaxSource":'/webSocketPro/pageSysInfoAjax?sysCode=',
