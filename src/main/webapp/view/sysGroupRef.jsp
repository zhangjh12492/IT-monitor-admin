...
--%>
        ...
        <div class="table_box" style="float: left; width: 40%; height: 100%">
            ...
            <div class="portlet-body">
                ...
                --%>
                <table id="system" class="table table-striped table-bordered table-hover">
                    <thead>
                    <tr>
                        <th>
                            编号
        ...
        <div class="table_box" style="float: left; width: 60%; height: 100%">
            <div class="table_tit">
                <div class="titname">
                    <i class="fa fa-globe"></i>用户组
                </div>
                <div class="actions">
                    <button id="groupAdd" data-toggle="modal" data-target="#groupDlg" class="btn btn-default btn-sm">
                        <i class="fa fa-pencil"></i> 新增
                    </button>
                </div>
            </div>
            <div class="portlet-body">
                ...
                --%>
                <table id="sysGroup" class="table table-striped table-bordered table-hover">
                    <thead>
                    <tr>
                        <th>
                            编号
        ...
        <div class="modal-content">
            ...
            <div class="portlet-body">
                <form id="usersEditForm">
                    <table id="groupEdit" class="table table-striped table-bordered table-hover">
                        <thead>
                        <tr>
...
<script type="text/javascript" src="<%=basePathVal%>/js/sysGroupRef.js"></script>
<script>
    /*
