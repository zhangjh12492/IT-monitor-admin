...
<script type="text/javascript" src="<%=basePathVal%>/js/groupUser.js"></script>
<script>
    /*
...
<script type="text/javascript" src="<%=basePathVal%>/js/jquery-easyui-1.3.2/jquery.easyui.min.js"></script>
