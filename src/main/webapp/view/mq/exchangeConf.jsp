                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input id="exchangeName" name="exchangeName" type="text" style="width: 300px"/>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <%--<input type="text" id="wsType" name="wsType" style="width: 200px"/>--%>
                                <select id="exchangeType" name="exchangeType" style="width: 300px">
                                    <option value="0" selected="selected">直接交换</option>
                                    <option value="1">fanout交换</option>
                                    <option value="2">topic交换</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <textarea type="text" id="exchangeDesc" name="exchangeDesc"
...
<script type="text/javascript" src="<%=basePath%>/js/mq/exchangeConf.js"></script>
