                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input id="systemNo" name="systemNo" type="text" style="width: 200px"
                                       readonly="readonly"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <%--<input type="text" id="serviceNo" name="serviceNo" style="width: 200px"/>--%>
                                <select id="serviceNo" name="serviceNo" style="width: 200px">
                        ...
                        <tr>
                            ...
                            <td>
                                <select onchange="exchangeType_change();" id="exchangeType"
                                        name="exchangeType" style="width: 200px">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="exchangeConfSid" name="exchangeConfSid" style="width: 200px">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="routeKey" name="routeKey" style="width: 200px"/>
                            </td>
                        </tr>
                        <%--
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="groupSid" name="groupSid" style="width: 200px"/>
                                                    </td>
                                                </tr>
                        --%>
                        <tr>
                            ...
                            <td>
                                <input type="text" id="maxLength" name="maxLength" style="width: 200px"/>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <textarea type="text" id="inboundDesc" name="inboundDesc"
...
<script type="text/javascript" src="<%=basePath%>/js/mq/inboundReg.js"></script>
<script>
    /*
