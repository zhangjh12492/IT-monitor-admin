...
<div class="page-container">
    <div class="page-content">
        ...
        <div class="table_box" style="float: left; width: 70%; height: 100%">
            <div class="table_tit">
                <div class="titname">
                    <i class="fa fa-globe"></i>报警配置信息列表
                </div>
                <div class="actions">
                ...
                <form id="groupForm" method="post">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="alarmNo" name="alarmNo" style="width: 200px"/>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <select id="alarmType" name="alarmType" style="width: 200px">
...
<script type="text/javascript" src="<%=basePath%>/js/mq/alarmConf.js"></script>
<script>
    /*
