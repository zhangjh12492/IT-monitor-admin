                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input id="outboundName" name="outboundName" type="text" style="width: 300px"/>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                ...
                                <select id="wsType" name="wsType" style="width: 300px">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="outboundUrl" name="outboundUrl" style="width: 300px"/>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="text" id="timeout" name="timeout" style="width: 300px"/>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <textarea id="outboundDesc" name="outboundDesc" style="width: 300px"></textarea>
                            </td>
                        </tr>
                        </thead>
                    </table>
