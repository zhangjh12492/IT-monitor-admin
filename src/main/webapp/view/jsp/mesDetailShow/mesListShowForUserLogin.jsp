...
<%--<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/static/css/datatables/jquery.dataTables.min.css"/>--%>
...
<input type="hidden" id="startRow" value="" />
...
<div class="page-container">
	<!-- BEGIN CONTENT -->
		<div class="page-content">
			...
			异常·异常信息列表     <small style="color:#fff;"></small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="javascript:void(0);">异常·异常信息列表 </a>
					</li>
				</ul>
										...
										<div class="modal-body form">
											<form action="#" class="form-horizontal form-row-seperated">
												...
												<div class="form-group last">
													...
													<div class="col-sm-8">
														<textarea id="detail_throwableDesc" class="help-block" disabled="disabled">
...
<script src="<%=request.getContextPath() %>/static/js/message/mesDetailShow/mesListShowForUserLogin.js"></script>
<script>
