...
<div class="page-container">
  ...
  <!--<div class="center clearfix">
    <div class="fl left_sidebar"></div>
    
        <div class="open_on clearfix">
            <span class="glyphicon glyphicon-transfer open"></span>
        </div>
        <ul class="side_tab clearfix">
            <li class="on">
                <a href="javascript:;">
                <i class="icon-home"></i>
                <span class="title">æ é¢1</span>
                </a>
                <ul class="menu">
                    <li>
                        <a href="javascript:;">
                        <i class="icon-bar-chart"></i>
                        <span class="title">kdjfldsgfdljgf</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="javascript:;">
                <i class="icon-basket"></i>
                <span class="title">æ é¢2</span>
                    </a>
            </li>
            <li>
                <a href="javascript:;">
                <i class="icon-rocket"></i>
                <span class="title">æ é¢3</span>
                    </a>
            </li>
            <li>
                <a href="javascript:;">
                <i class="icon-puzzle"></i>
                <span class="title">æ é¢4</span>
                    </a>
            </li>
            <li>
                <a href="javascript:;">
                <i class="icon-paper-plane"></i>
                <span class="title">æ é¢5</span>
                    </a>
            </li>
        </ul>
    ...
    <div class="fl right_main">fksjurfoeftrlksdjflds</div>
</div>-->
