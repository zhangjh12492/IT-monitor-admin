    ...
    <div class="page-content">
        ...
        <div class="portlet box blue-hoki" style="float: left; width: 40%; height: 100%">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>预警列表
                </div>
                <%--
                            <div class="actions">
                                <button id="modal_link" data-toggle="modal" data-target="#groupDlg" class="btn btn-default btn-sm">
        ...
        <div class="portlet box blue-hoki" style="float: left; width: 60%; height: 100%">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <button id="sysInfoAdd" data-toggle="modal" data-target="#sysInfoDlg" class="btn btn-default btn-sm">
                        <i class="fa fa-pencil"></i> 新增
                    </button>
                </div>
            </div>
...
<%--组form--%>
<div id="sysInfoDlg" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div id="groupDialog" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="portlet-body">
                <table id="sysInfoEdit" class="table table-striped table-bordered table-hover">
                    <thead>
                    <tr>
            ...
            <div class="modal-footer">
                <button type="button" class="btn blue" id="ewSysInfoSave">保存</button>
...
<script type="text/javascript" src="${contextPath }static/js/message/mesEarlyWarn/earlyWarnSysInfo.js"></script>
<script>
