...
<div class="page-container">
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a href="javascript:void(0);">业务·短信配置管理</a>
				</li>
			</ul>
		...
		<div class="table_box">
			<div class="table_tit">
				<div class="titname">
					<i class="fa fa-globe"></i>短信配置信息
				</div>
				<div class="actions">
					<button id="smsConfigInfoAdd" data-toggle="modal" data-target="#smsConfigInfoFormDlg" class="btn btn-default btn-sm">
						<i class="fa fa-pencil"></i> 新增
					</button>
				</div>
			</div>
			<div class="portlet-body" style="height: 100%">
				<table id="smsConfigInfoTable" class="table table-striped table-bordered table-hover">
					<thead>
					<tr>
						<th>
							序号
	...
	<%--form--%>
	<div id="smsConfigInfoFormDlg" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title">增加短信配置信息</h4>
				</div>
				<div class="portlet-body">
					<form id="smsConfigInfoForm" method="post">
						<table class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td>
									...
									<input id="smsSendUrl" name="smsSendUrl" type="text" style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<th>
				...
				<div class="modal-footer">
					<button id="btnSaveSmsConfigInfo" type="button" class="btn blue">保存</button>
...
<script src="${contextPath }static/js/message/sms/smsConfigInfo.js"></script>
