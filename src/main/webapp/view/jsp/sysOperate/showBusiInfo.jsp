...
<div class="page-container">
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				<li>
					...
					<a href="${pageContext}sysOperate.do?showSysInfo&sysCode">系统监控</a>
					<i class="fa fa-angle-right"></i>
				</li>
				<li>
					<a href="javascript:void(0);">业务·业务管理</a>
				</li>
			</ul>
		...
		<div class="table_box">
			<div class="table_tit">
				<div class="titname">
					<i class="fa fa-globe"></i>业务信息
				</div>
				<div class="actions">
					<button id="busiInfoAdd" data-toggle="modal" data-target="#busiInfoFormDlg" class="btn btn-default btn-sm">
						<i class="fa fa-pencil"></i> 新增
					</button>
				</div>
			</div>
			<div class="portlet-body" style="height: 100%">
				<table id="busiInfo" class="table table-striped table-bordered table-hover">
					<thead>
					<tr>
						<th>
							编号
	...
	<%--form--%>
	<div id="busiInfoFormDlg" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title">增加业务信息</h4>
				</div>
				<div class="portlet-body">
					<form id="busiInfoForm" method="post">
						<table class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td>
									...
									<input id="busiCode" name="busiCode" type="text" style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input id="busiDesc" name="busiDesc" type="text" style="width: 200px"/>
				...
				<div class="modal-footer">
					<button id="btnSaveBusiInfo" type="button" class="btn blue">保存</button>
...
<script src="${contextPath }static/js/message/sysOperateJs/busiInfo.js"></script>
<script>
