...
<!-- BEGIN CONTAINER -->
	...
	<div class="page-container">
		<div class="page-content">
	        ...
	        <div class="table_box">
	            <div class="table_tit">
	                <div class="titname">
	                    <i class="fa fa-globe"></i>邮件配置信息
	                </div>
	                <div class="actions">
	                   <button id="mailConfigInfoAdd" data-toggle="modal" data-target="#mailConfigInfoFormDlg" class="btn btn-default btn-sm">
	                        <i class="fa fa-pencil"></i> 新增
	                    </button>
	                </div>
	            </div>
	            <div class="portlet-body" style="height: 100%">
	                <table id="mailConfigInfoTable" class="table table-striped table-bordered table-hover">
	                    <thead>
	                    <tr>
	                        <th>
	                            序号
	...
	<%--form--%>
<div id="mailConfigInfoFormDlg" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">增加邮件配置信息</h4>
            </div>
            <div class="portlet-body">
                <form id="mailConfigInfoForm" method="post">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input id="mailServer" name="mailServer" type="text" style="width: 200px"/>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input id="mailSender" name="mailSender" type="text" style="width: 200px"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="mailNickName" name="mailNickName" type="text" style="width: 200px"/>
                            </td>
                        </tr>
						<tr>
                            <th>
                            ...
                            <td>
                                <input id="mailUserName" name="mailUserName" type="text" style="width: 200px"/>
                            </td>
                        </tr>
						<tr>
                            <th>
                            ...
                            <td>
                                <input id="mailPassword" name="mailPassword" type="password" style="width: 200px"/>
                            </td>
                        </tr>
						<tr>
                            <th>
                            ...
                            <td>
								<select class="form-control" name="usedStatus" id="usedStatus">
            ...
            <div class="modal-footer">
                <button id="btnSaveMailConfigInfo" type="button" class="btn blue">保存</button>
...
<script src="${contextPath }static/js/message/mail/mailConfigInfo.js"></script>
