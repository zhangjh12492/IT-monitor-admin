...
groupTable = $("#group").dataTable({
    "sAjaxSource": "roleRes.do?getRoleList",
    "bProcessing": true,
...
//        usersTable.fnClearTable();
    ...
    userEditTable = $("#usersEdit").dataTable({
            ...
            "bFilter": false,
            "bSort": true,
            "sAjaxSource": "roleRes.do?getNotExistRes&roleId=" + groupId,
            "bProcessing": true,
            "searching": false, //去掉搜索框
            "bLengthChange": false,// 是否允许自定义每页显示条数.
            "aLengthMenu": [
...
//        "bRetrieve": true,
        "sAjaxSource": "roleRes.do?selectResByRoleid&roleId=" + groupId,
        "bProcessing": true,
        "searching": false, //去掉搜索框
        "bLengthChange": false,// 是否允许自定义每页显示条数.
        "aLengthMenu": [
...
function deleteUser(id) {
    ...
    if (se == true) {
        $.ajax({
            url: 'roleRes.do?delRoleRes&id=' + id,
            type: 'POST',
            dataType: 'json',
            data: {
            },
