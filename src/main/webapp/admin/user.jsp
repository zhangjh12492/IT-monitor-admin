...
<div region="center" border="false" style="overflow: hidden;">
    <div id="toolbar" class="datagrid-toolbar" style="height: auto;">
        <fieldset>
            <table class="tableForm">
                ...
                <tr height="30">
                    <th>创建时间</th>
                    <td colspan="2">
                        <input name="createdatetimeStart" class="easyui-datetimebox" editable="false"
                               style="width: 150px;"/>
                        -
                ...
                <tr height="30">
                    <th>最后修改时间</th>
                    <td><input name="modifydatetimeStart" class="easyui-datetimebox" editable="false"
                               style="width: 150px;"/>
                        -
                        <input name="modifydatetimeEnd" class="easyui-datetimebox"
        ...
        <div>
            ...
            <a class="easyui-linkbutton" iconCls="icon-remove" onclick="remove();" plain="true"
               href="javascript:void(0);">删除</a> <a class="easyui-linkbutton" iconCls="icon-edit" onclick="edit();"
                                                    plain="true" href="javascript:void(0);">编辑</a> <a
                class="easyui-linkbutton" iconCls="icon-edit" onclick="editRole();" plain="true"
                href="javascript:void(0);">批量更改角色</a> <a class="easyui-linkbutton" iconCls="icon-undo"
...
<div id="userDialog" style="display: none;overflow: hidden;">
    <form id="userForm" method="post">
        <table class="tableForm">
            ...
            <tr>
                <th>email</th>
                <td><input name="email" class="easyui-validatebox" required="true"/>
                </td>
            </tr>
            <tr>
                <th>电话号码</th>
                <td><input name="tel" class="easyui-validatebox" required="true"/>
                </td>
            </tr>
<%--
            <tr>
