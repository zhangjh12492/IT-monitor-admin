            ...
            <div class="portlet-body">
                <form id="menu2" method="post">
                    <ul class="groupList">
                        ...
                        <li>
                            <label>排序</label>
                            <input type="text" id="seq_2" name="seq" style="width: 300px"
                        ...
                        <li>
                            <label>是否验证</label>
                            <select id="onoff" style="width: 260px">
...
<script type="text/javascript" src="<%=basePathVal%>/admin/js/resources_3.js"></script>
<script>
    /*
