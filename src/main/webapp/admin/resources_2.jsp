...
<div class="page-container">
    <div class="page-content">
        ...
        <div class="table_box" style="float: left; width: 200px; height: 100%">
            <div class="table_tit broder_r">
                <div class="titname">
                    <i class="fa fa-globe"></i>资源管理
                </div>
                <div class="actions">
...
--%>
        ...
        <div class="table_box" style="width: 100%; height: 100%">
            <div class="table_tit">
                <div class="titname">
            ...
            <div class="portlet-body">
                <form id="groupForm" method="post">
                    <ul class="groupList">
                        ...
                        <li>
                            <label>开关</label>
                            <input type="text" id="onoff" name="onoff"/>
                        </li>
                    </ul>
                </form>
            </div>
...
<script type="text/javascript" src="<%=basePathVal%>/admin/js/resources_2.js"></script>
<script>
</script>
