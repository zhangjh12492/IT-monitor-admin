...
<link href="./metronic_v35/theme/assets/admin/pages/css/login.css" rel="stylesheet" type="text/css"/>
<!-- END PAGE LEVEL SCRIPTS -->
<!-- BEGIN THEME STYLES -->
<link href="./metronic_v35/theme/assets/global/css/components.css" id="style_components" rel="stylesheet" type="text/css"/>
...
<link href="./metronic_v35/theme/assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
...
<div class="logo">
	<a href="index.html">
	<img src="./metronic_v35/theme/assets/admin/layout/img/logo-big.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="login.do?login" method="post">
		...
		<div class="form-actions">
			<button id="btnLogin" type="submit" class="btn btn-success uppercase">登录</button>
...
<!-- END LOGIN -->
<jsp:include page="./view/common.jsp"></jsp:include>
