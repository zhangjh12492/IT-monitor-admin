...
public class Syrole implements java.io.Serializable {
	...
	private Set syroleSymenus = new HashSet(0);
	...
	/** full constructor */
	public Syrole(String id, Syrole syrole, String text, BigDecimal seq, String descript, Set syuserSyroles, Set syroles, Set syroleSyresourceses,Set syroleSymenus) {
		this.id = id;
		this.syrole = syrole;
		this.text = text;
		this.seq = seq;
        ...
        this.syroleSymenus = syroleSymenus;
	}
    ...
    public Set getSyroleSymenus() {
        return syroleSymenus;
    }

    public void setSyroleSymenus(Set syroleSymenus) {
        this.syroleSymenus = syroleSymenus;
    }
}