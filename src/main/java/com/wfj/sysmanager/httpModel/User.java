...
import com.wfj.sysmanager.util.JsonDateSerializer;
...
public class User implements java.io.Serializable {
    ...
    public void setStock_sid(String[] stock_sid) {
        this.stock_sid = stock_sid;
    }

    public String[] getSupply_info_sid() {
		return supply_info_sid;
	}

	public void setSupply_info_sid(String[] supplyInfoSid) {
		supply_info_sid = supplyInfoSid;
	}
...
//	@JsonSerialize(using = JsonDateSerializer.class)
	...
	public String toString() {
		return "User{" +
				...
				", supply_info_sid=" + Arrays.toString(supply_info_sid) +
				", stock_sid=" + Arrays.toString(stock_sid) +
				", ip='" + ip + '\'' +
				'}';
	}
}
